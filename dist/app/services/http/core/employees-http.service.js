...
let EmployeesHttpService = class EmployeesHttpService {
    constructor() {
        this.API_URL = `${environment.API_URL}/employees`;
...
EmployeesHttpService = __decorate([
    Injectable({
        providedIn: 'root'
    })
], EmployeesHttpService);
export { EmployeesHttpService };
//# sourceMappingURL=employees-http.service.js.map